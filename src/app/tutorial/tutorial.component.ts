...
<file source-language="en-US" datatype="plaintext" original="ng2.template" target-language="en-UK">
  <body>
    ...
    <trans-unit id="the.unique.identifiers.15" datatype="html">
      ...
      <target state="translated">Complex translations <x id="dummy" equiv-text="with a jigsaw puzzle symbol" /></target>
    </trans-unit>
    ...
    <trans-unit id="the.unique.identifiers.17" datatype="html">
      ...
      <target state="translated">...it is because the translation contains fragments that I cannot interpret (yet).</target>
    </trans-unit>
  </body>
</file>
</xliff>`;
